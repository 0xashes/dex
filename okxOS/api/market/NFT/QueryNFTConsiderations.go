...
const (
	NFTConsiderationsEndpoint = "/api/v5/mktplace/nft/markets/offers" // 查询出价单(offer)
	NFTConsiderationsMethod   = "GET"
)

type NFTConsiderationsParams struct {
...
type NFTConsiderationsResponse struct {
	Cursor string           `json:"cursor"`
	Data   []OKXOrdersModel `json:"data"`
}

// Deprecated
func QueryNFTConsiderations(client *common.Client, params *NFTConsiderationsParams) (*common.OKXOSResponse[NFTConsiderationsResponse], error) {
	response := &common.OKXOSResponse[NFTConsiderationsResponse]{}
