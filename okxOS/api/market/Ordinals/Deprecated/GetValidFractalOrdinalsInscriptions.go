...
const (
	ValidFractalOrdinalsInscriptionsEndpoint = "/api/v5/mktplace/nft/fractal-ordinals/get-valid-inscriptions"
	ValidFractalOrdinalsInscriptionsMethod   = "GET"
)

type ValidFractalOrdinalsInscriptionsParams struct {
...
type ValidFractalOrdinalsInscriptionsResponse struct {
	Code int    `json:"code"`
	Msg  string `json:"msg"`
}

// 执行请求
func GetValidFractalOrdinalsInscriptions(client *common.Client, params *ValidFractalOrdinalsInscriptionsParams) (*ValidFractalOrdinalsInscriptionsResponse, error) {
	response := &ValidFractalOrdinalsInscriptionsResponse{}
	err := client.DoRequest(ValidFractalOrdinalsInscriptionsMethod, ValidFractalOrdinalsInscriptionsEndpoint, params, response)
	if err != nil {
		return nil, err
	}
	return response, nil
